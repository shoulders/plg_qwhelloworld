...
<div class="<?php echo 'plg_content_'.$this->_name ?> alternative">
	<p class="template_msg"><strong><?php echo JText::_('PLG_CONTENT_HELLOWORLD_ALTERNATIVE_TEMPLATE_MSG'); ?></strong></p>
